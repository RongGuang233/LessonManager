...
- 在周课表空档排课，默认使用学生的常规课长；可每周重复、复制上周、修改时间或请假。复制前显示当前筛选范围、学生、节数与冲突；批量调课逐项预览，只同步改动过的字段，保留后续课程的单独安排。连续停课可选择日期范围或同系列后续课程，预览后统一取消，保留已上课程。
- 学生概览可直接“加一节课”；取消课程可“安排补课”，预填学生、科目和常规课长，原请假记录保留。课程详情按待上、已上和取消状态展示相关信息。
